...
function postExecutionAssertions(metrics, storyKey) {
  const issues = [];
...
async function runOneScript(scriptPath, outBaseDir, thresholdsByType, globalThresholds) {
  const {
    runPerfTest, parsePerfResults, evaluateThresholds, compareToBaseline,
    updateBaseline, saveThresholdsForRun, resolveThresholds,
